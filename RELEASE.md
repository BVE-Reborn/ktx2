...
This document describes how to publish a new release of `ktx2`.
...
```
- [Unreleased](https://github.com/BVE-Reborn/ktx2/compare/vPREVIOUS...HEAD)
```
Update it and add a new entry:
```
- [Unreleased](https://github.com/BVE-Reborn/ktx2/compare/vX.Y.Z...HEAD)
- [vX.Y.Z](https://github.com/BVE-Reborn/ktx2/compare/vPREVIOUS...vX.Y.Z)
```
...
Verify:
- [ ] The crate is visible at https://crates.io/crates/ktx2/X.Y.Z
- [ ] Docs are building at https://docs.rs/ktx2/X.Y.Z
- [ ] The GitHub release exists at https://github.com/BVE-Reborn/ktx2/releases/tag/vX.Y.Z
